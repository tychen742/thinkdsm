...
if '__name__' == __main__:
    elves_data = get_data_from_web(
        'http://www.datacarpentry.org/semester-biology/data/houseelf-earlength-dna-data.csv')
    ...
    for size_class in size_classes:
        gc_vals = [gc_content[i]
                   for i in range(len(gc_content)) if sizes[i] == size_class]
