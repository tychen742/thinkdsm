...
This is a follow up to [GC Content 2](./exercises/Functions-gc-content-2-Python/).
...
Use a `for` loop and your function from [GC Content 2](./exercises/Functions-gc-content-2-Python/) to calculate the 
